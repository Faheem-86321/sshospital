...
if (isset($_POST['payment_receieved_dialysis'])) {
    ...
    $update_data = "UPDATE ssh_p_dialysis SET file_status = '2'  WHERE pd_id='".$payment_receieved_dialysis."' ";
...
if (isset($_POST['payment_receieved'])) {
    ...
    date_default_timezone_set("Asia/Karachi");
    $update_data = "UPDATE ssh_p_indoor SET file_status = '2'  WHERE pi_id='".$payment_receieved."' ";
    $update_data_ex = mysqli_query($con,$update_data);
    if ($update_data_ex) {
     echo 'true';
 }else{
