            ...
            <div class="modal-body p-4">
               ...
               <!--  <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="number" class="form-control" name="Paid" value="5040" required  id="charges">
                            ...
                            if (isset($_GET['search_date'])) { 
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th colspan="4"><?php echo $_GET['search_date']."<br>".date('l',strtotime($_GET['search_date'])) ?></th>
                            ...
                            <?php }else{
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th colspan="4"><?php echo date('Y-m-d')."<br>".date('l') ?></th>
