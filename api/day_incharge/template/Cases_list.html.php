            ...
            <div class="modal-body p-4">
               <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center"> Note: Receptionist will set case total fee while admission</div>
                    <div class="form-group col-md-12">
                        <label for="name">Total <sub style="color: green !important;">(Readonly)</sub> <span style="color: red;"> *</span></label>
                        <input type="number" class="form-control" name="ser_charges" value="0" readonly required>
                    </div>
                        ...
                        <div class="card-box card-table-style" style="padding: 0px 4px !important;">
                            <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                ...
                                <tbody>
                                    <?php
                                    $sr = 1;
                                    $fetch_data = "SELECT S_ID,Title,Charges from ssh_cases_indoor where type = '0' AND close = '1' ";
