...
<button id="updateinfobutton" hidden class="btn " data-toggle="modal" data-target="#updateinfo" style="background: #21325E; color: white;" ><i class="mdi mdi-plus-circle mr-2"></i> View Private Patient </button>
<div class="modal fade" id="updateinfo" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title" id="myCenterModalLabel"> View Private Patient</h4>
...
<button id="updateinfobutton0" hidden class="btn " data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#updateinfo0" style="background: #21325E; color: white;" ><i class="mdi mdi-plus-circle mr-2"></i> Update Private Patient </button>
<div class="modal fade" id="updateinfo0" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title" id="myCenterModalLabel"> Update Private Patient</h4>
...
<div class="modal fade" id="add-custom-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myCenterModalLabel">Add Private Patient</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
                            ...
                            if (isset($_GET['search_date'])) { 
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    ...
                                    <tbody>
                                        ...
                                        $sr_no = 1;
                                        $total_paid = 0;
                                        $fetch_data = "SELECT * FROM ssh_p_indoor JOIN ssh_p_reg ON ssh_p_indoor.P_ID = ssh_p_reg.P_ID LEFT JOIN ssh_cases_indoor ON ssh_p_indoor.S_ID = ssh_cases_indoor.S_ID LEFT JOIN indoor_room ON ssh_p_indoor.room_id = indoor_room.ir_id where ssh_p_indoor.admit_date = '".$_GET['search_date']."' AND ssh_p_indoor.admition_type = '0' ";
                            ...
                            <?php }elseif (isset($_GET['view_admit'])) { 
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    ...
                                    <tbody>
                                        ...
                                        $sr_no = 1;
                                        $total_paid = 0;
                                        $fetch_data = "SELECT * FROM ssh_p_indoor JOIN ssh_p_reg ON ssh_p_indoor.P_ID = ssh_p_reg.P_ID LEFT JOIN ssh_cases_indoor ON ssh_p_indoor.S_ID = ssh_cases_indoor.S_ID LEFT JOIN indoor_room ON ssh_p_indoor.room_id = indoor_room.ir_id where ssh_p_indoor.exit_date = '0000-00-00' AND ssh_p_indoor.admition_type = '0' ";
                                        $fetch_data_ex = mysqli_query($con,$fetch_data);
                                        foreach($fetch_data_ex as $row){ 
                                            ?>
                                            <tr id="<?php echo $row['pi_id'] ?>">
                            ...
                            <?php }else{
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    ...
                                    <tbody>
                                        ...
                                        $total_paid = 0;
                                        $sr_no = 1;
                                        $fetch_data = "SELECT * FROM ssh_p_indoor JOIN ssh_p_reg ON ssh_p_indoor.P_ID = ssh_p_reg.P_ID LEFT JOIN ssh_cases_indoor ON ssh_p_indoor.S_ID = ssh_cases_indoor.S_ID LEFT JOIN indoor_room ON ssh_p_indoor.room_id = indoor_room.ir_id where ssh_p_indoor.admit_date = '".date('Y-m-d')."' AND ssh_p_indoor.admition_type = '0' ";
                                        $fetch_data_ex = mysqli_query($con,$fetch_data);
                                        foreach($fetch_data_ex as $row){ 
                                            ?>
                                            <tr id="<?php echo $row['pi_id'] ?>">
...
<script type="text/javascript">
    ...
    function update_info(idcus) {
        ...
        $.ajax({
            type:"POST",
            url:"models/indoor.php",
            data: 'update_admit_private='+idcus,
            success:function(data) {
