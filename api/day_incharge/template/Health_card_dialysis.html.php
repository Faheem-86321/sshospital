    ...
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title" id="myCenterModalLabel"> View Health Card Dialysis</h4>
...
<div class="modal fade" id="add-custom-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myCenterModalLabel">Add Health Card Dialysis</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body p-4">
               <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="visitor_id" required value="">   
                    </div>
                    <div class="form-group col-md-12">
               ...
               <!--  <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="number" class="form-control" name="Paid" value="5040" required readonly id="charges">
                    <input type="number" class="form-control" value="5040" hidden  id="calcharges" required>
                </div>
            </div>    
...
<div class="col-xl-12  col-lg-12">
    <div class="card">
        <div class="card-body" dir="ltr">
            <button id="onloadclick" class="btn" data-toggle="modal" data-target="#add-custom-modal" style="background: #f24c4f; color: black;float: left;" ><i class="mdi mdi-plus-circle "></i> Add Health Card Dialysis </button>
            ...
            <div class="text-center">
                <form action="" method="get" enctype="multipart/form-data">
                    <div class="row">
                    <input type="date" class="form-control mr-1"  name="date_from"  style="width: 150px;float: left;" required>
                        <span style="float: left;" class="mr-1"><b>To</b></span>
                        <input type="date" class="form-control mr-1"  name="date_to"  style="width: 150px;float: left;" required>
                        <input type="submit" class="btn btn-success mr-1"  name="search_date" value="Search"  style="float: left;height: 36px;">
                        </div>
                </form>
            </div> 
                            ...
                            if (isset($_GET['search_date'])) { 
                                ...
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th colspan="5"><?php echo $_GET['date_from']." to ".$_GET['date_to'] ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        $total_paid = 0;
                                        $sr_no = 1;
                                        $fetch_data = "SELECT * FROM ssh_p_dialysis JOIN ssh_p_reg ON ssh_p_dialysis.P_ID = ssh_p_reg.P_ID  where ssh_p_dialysis.date BETWEEN '".$_GET['date_from']."' AND '".$_GET['date_to']."' AND ssh_p_dialysis.admission_type = '1' ";
                                        ...
                                        foreach($fetch_data_ex as $row){ 
                                            ...
                                            <tr id="<?php echo $row['pd_id'] ?>">
                                                ...
                                                <td><button class='btn btn-danger' onclick="del(delC,<?php echo $row['pd_id']; ?>);"  style='padding: 6px 6px;margin: 2px; border-radius: 3px; color: white; '><i class='fa fa-trash ' aria-hidden='true'></i></button></td>
                                                <?php  
                                                
                                                if ($row['injection'] == '1') {
                                                     echo "<td>".$row['Name']."<br>".$row['Paid']."</td><td>Yes</td><td>".$row['phone']."</td><td>".$row['date']."</td>";
                                                }elseif($row['injection'] == '0'){
                                                    echo "<td>".$row['Name']."<br>".$row['Paid']."</td><td>No</td><td>".$row['phone']."</td><td>".$row['date']."</td>"; 
                                                }else{
                                                    echo "<td>".$row['Name']."<br>".$row['Paid']."</td><td>Unknown</td><td>".$row['phone']."</td><td>".$row['date']."</td>";
                                                }
                                                ?>
                                    ...
                                    <tbody>
                                        ...
                                        foreach($fetch_data_ex as $row){ 
                                            ...
                                            <tr id="<?php echo $row['pd_id'] ?>">
                                                ...
                                                <?php 
                                                if ($row['injection'] == '1') {
                                                    echo "<td>".$row['Name']."</td><td>Yes</td><td>".$row['phone']."</td><td>".$row['Paid']."</td>";     
                                                }elseif($row['injection'] == '0'){
                                                    echo "<td>".$row['Name']."</td><td>No</td><td>".$row['phone']."</td><td>".$row['Paid']."</td>";   
                                                }else{
                                                    echo "<td>".$row['Name']."</td><td>Unknown</td><td>".$row['phone']."</td><td>".$row['Paid']."</td>";   
                                                }
                                                ?>
                                            </tr>
                                            <?php 
