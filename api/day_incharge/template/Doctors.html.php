                                        ...
                                        foreach($fetch_data_ex as $row){ ?>
                                            <tr id="<?php echo $row['D_ID']; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a class='btn btn-primary ' onclick="update_info(<?php echo $row['D_ID']; ?>);" style='padding: 6px 6px;margin: 2px; border-radius: 3px;color:white'><i class='fa fa-edit' aria-hidden='true'></i></a>
                                                    <?php if ($row['D_ID'] != 16 && $row['D_ID'] != 17) { ?>
                                                        <button class='btn btn-danger ' onclick="del(delC,<?php echo $row['D_ID']; ?>);"  style='padding: 6px 6px;margin: 2px; border-radius: 3px; color: white; '><i class='fa fa-trash ' aria-hidden='true'></i></button>
                                                    <?php } ?>
