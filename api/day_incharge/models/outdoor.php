...
if (isset($_POST['get_doctor_fee'])) {
    ...
    foreach($view_data_ex as $row){ 
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="name"> Doctor Wages <sub style="color: green !important;">(Readonly)</sub><span style="color: red;"> *</span></label>
                <input type="number" class="form-control" onkeyup="" value="<?php echo $row['Wages']; ?>" name='pat_paid' id='pat_paid'  required min="0" readonly >
            </div>
            <div class="form-group col-md-12">
