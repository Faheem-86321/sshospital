               ...
               <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <select  class="form-control" name="case_id" id="case_id" onchange="validate_doc_fee();"   required>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" class="form-control" name="doc_charges" value="0" required>
                    </div>
                        ...
                        <div class="card-box card-table-style" style="padding: 0px 4px !important;">
                            <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                ...
                                <tbody>
                                    <?php
                                    $sr = 1;
                                    $fetch_data = "SELECT * from ssh_docsetting_indoor JOIN ssh_cases_indoor ON ssh_docsetting_indoor.S_ID = ssh_cases_indoor.S_ID  LEFT JOIN ssh_dr_reg ON ssh_docsetting_indoor.D_ID = ssh_dr_reg.D_ID where ssh_docsetting_indoor.close = '1' AND ssh_cases_indoor.type = '0'  ";
