    ...
    <div class="card">
        <div class="card-body" dir="ltr">
            <a href="health_card_patient?view_admit=1" id="" class="btn mr-1 "  style="background: #f24c4f; color: black;float: left;" ><i class="fa fa-eye "></i> View Admited Patients </a>
             <a href="health_card_patient?view_discharged=1" id="" class="btn mr-1 "  style="background: #f24c4f; color: black;float: left;" ><i class="fa fa-eye "></i> View Today Discharged Patients </a>
                ...
                <div class="row bodyoftable" style="padding: 0px 4px !important;">
                    <div class="col-sm-12" style="padding: 0px 4px !important;">
                        <div class="card-box card-table-style" style="padding: 0px 4px !important;">
                            ...
                            <?php }
                            elseif (isset($_GET['view_discharged'])) { 
                                date_default_timezone_set("Asia/Karachi");
                                ?>
                                <table id="example"  class="table table-centered table-striped table-bordered mb-0 toggle-circle" >
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        $sr_no = 1;
                                        $total_paid = 0;
                                        $fetch_data = "SELECT * FROM ssh_p_indoor JOIN ssh_p_reg ON ssh_p_indoor.P_ID = ssh_p_reg.P_ID LEFT JOIN ssh_cases_indoor ON ssh_p_indoor.S_ID = ssh_cases_indoor.S_ID LEFT JOIN indoor_room ON ssh_p_indoor.room_id = indoor_room.ir_id where ssh_p_indoor.exit_date = '".date('Y-m-d')."' AND ssh_p_indoor.admition_type = '1' ";
                                        $fetch_data_ex = mysqli_query($con,$fetch_data);
                                        foreach($fetch_data_ex as $row){ 
                                            ?>
                                            <tr id="<?php echo $row['pi_id'] ?>">
