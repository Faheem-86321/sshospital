  <div class="row">
    ...
    <div class="col-md-3 col-sm-6">
        <div class="counter blue">
            ...
            <?php
            date_default_timezone_set("Asia/Karachi");
            $fetch_data_dialysis = "SELECT * FROM ssh_p_dialysis JOIN ssh_p_reg ON ssh_p_dialysis.P_ID = ssh_p_reg.P_ID  WHERE ssh_p_dialysis.admission_type = '1'  AND ssh_p_dialysis.date = '".date('Y-m-d')."'";
