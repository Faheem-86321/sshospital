    ...
    <div class="col-lg-4 col-xl-4">
        <div class="card-box text-center">
            ...
            <div class="text-left mt-3">
                ...
                <p class="text-muted mb-1 font-13"><strong>Location :</strong> <span class="ml-2"><?php echo $row['address'] ;?></span></p>
            </div>
        </div> <!-- end card-box -->
    </div> <!-- end col-->
                ...
                <div class="tab-pane active show" id="settings">
                    <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $row['fname'] ;?>"  class="form-control" id="firstname" required name="fname" placeholder="Enter first name">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="<?php echo $row['email'] ;?>" required name="email" class="form-control" id="useremail" placeholder="Enter email">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="file" name="profile_pic" data-plugins="dropify" required data-default-file="../images/<?php echo $row['profile_pic'];?>"  />
                        </div>
                    </div> <!-- end row -->
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="userbio">Location</label>
                                <textarea class="form-control" value="<?php echo $row['address'] ;?>"  id="userbio" rows="4" name="address" placeholder="Write something..."></textarea>
                            </div>
                        </div>
                        <!-- end col -->
                    </div> <!-- end row -->
