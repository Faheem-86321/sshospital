...
<ul class="list-unstyled topnav-menu topnav-menu-left m-0">
    ...
    <li style="text-align: center;width: 15%;">
        <div class="date_time_div mt-2" style="color: black !important;padding: 0px;">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="alert" style="color: black; font-size: 20px; font-weight: bold; ">
                        ...
                        <?php  echo ucwords(str_replace("_", " ",$_SESSION['user_type']))." / ".$head_title1 = ucwords(str_replace("_", " ", $head_title));?>
                        <marquee style="width: 60%;float: right;color: black;">
                            
                            <?php
                                        $total_ex = 0;
                                        $fetch_data = "SELECT * FROM `ssh_ser_inv` where (ID = '1' OR ID = '2' OR ID = '6') AND Stock < '20' ";
                                        $fetch_data_ex = mysqli_query($con,$fetch_data);
                                        foreach($fetch_data_ex as $row){ ?>
                                            
                                                <?php echo " | ".$row['Title']." <span class='badge badge-danger'> ".$row['Stock']."</span>"; ?>
                                            
                                            <?php 
                                        }
                                        $fetch_data = "SELECT * FROM `dialysis_item` Where stock < '20'";
                                        $fetch_data_ex = mysqli_query($con,$fetch_data);
                                        foreach($fetch_data_ex as $row){ ?>
                                            
                                                <?php echo " | ".$row['item_name']." <span class='badge badge-danger'> ".$row['stock']."</span>"; ?>
